...
int main()
{
    ...
    param.ocdnet_trt_engine_path = (char *)"/home/guillaume/Workspace/models/pretrained/ocdnet.resnet50.fp16.engine";
    ...
    param.ocrnet_trt_engine_path = (char *)"/home/guillaume/Workspace/models/pretrained/ocrnet.resnet50.fp16.engine";
    param.ocrnet_dict_file = (char *)"/home/guillaume/Workspace/models/pretrained/character_list";
    ...
    // Load the input
    const char* img_path = "/home/guillaume/Workspace/Photos/1.png";
    cv::Mat img = cv::imread(img_path);
    nvOCDRInput input;
